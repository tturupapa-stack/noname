  ...
  return (
    <div className="min-h-screen relative bg-dawn-gradient">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-5xl relative z-10">
        ...
        {/* WANT MORE? AI 분석 유도 섹션 */}
        <section className="mt-8 animate-fade-in-up" style={{ animationDelay: '0.3s', opacity: 0 }}>
          <div className="card-glass p-6 sm:p-8 border-2 border-dashed border-[var(--accent)]/30 hover:border-[var(--accent)]/50 transition-colors">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-gradient-to-br from-[#ff7e5f] to-[#feb47b]">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl sm:text-2xl font-black text-dawn mb-2">WANT MORE?</h3>
              <p className="text-[var(--foreground-muted)] mb-6 max-w-md mx-auto">
                이 종목에 대한 더 깊은 AI 분석을 원하시나요?<br />
                실시간 뉴스 기반의 상세한 투자 인사이트를 받아보세요.
              </p>
              <Link
                href={`/stock/${briefing.symbol}`}
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#ff7e5f] to-[#feb47b] text-white font-bold rounded-lg hover:opacity-90 transition-opacity"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-[var(--foreground-muted)] mt-4 opacity-60">
                생성된 AI 분석은 MY ANALYSIS에서 확인할 수 있습니다
              </p>
            </div>
          </div>
        </section>
